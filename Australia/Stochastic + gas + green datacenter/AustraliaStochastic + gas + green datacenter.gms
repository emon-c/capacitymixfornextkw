...
GasRamp /0.5/
EmissionsCap /10000/
DatacenterRatio fraction of load to scale datacenter demand /0.50/
...
Obj.. Cost =e= Sum((t,s,g), Gen(g,s,t)*GenData(g,"opex")*365*REUncert(g,s,"Prob") + GenRETotal(g,s,t)*GenData(g,"opex")*365*REUncert(g,s,"Prob"))
             ...
             + Sum((s,t), ((Unmet(s,t) + Unmet1(s,t))*1 + (Surplus(s,t)+Surplus1(s,t))*0.5)*Uncert(s))*365
;
...
display cap.l, genstorcap.l, greenstorcap.l, gen.l, storgeninj.l, storgenout.l,storgreeninj.l, storgreenout.l, unmet.l, surplus.l, GenRE1.l, GenRE2.l;
...
Summary ("Gen. Stor.","Cap kWh") = GenStorCap.l ;
Summary ("Green Stor.","Cap kWh") = GreenStorCap.l ;
Summary ("Total Stor.","Cap kWh") = GenStorCap.l + GreenStorCap.l ;
...
Summary ("Total Stor.","Cap. ex") = (GenStorCap.l + GreenStorCap.l)*180 ;
Summary ("Total","Cap. ex") = Summary ("Coal","Cap. ex") + Summary ("Gas","Cap. ex") + Summary ("Solar","Cap. ex")+Summary ("Wind","Cap. ex")+Summary ("Total Stor.","Cap. ex");
...
Summary ("Total Stor.","Ann. Capex") = (GenStorCap.l + GreenStorCap.l)*27 ;
Summary ("Total","Ann. Capex") = Summary ("Coal","Ann. Capex") + Summary ("Gas","Ann. Capex") + Summary ("Solar","Ann. Capex")+Summary ("Wind","Ann. Capex")+Summary ("Total Stor.","Ann. Capex");
...
Summary ("Total Stor.","Fixed O&M") = (GenStorCap.l + GreenStorCap.l)*7 ;
Summary ("Total","Fixed O&M") = Summary ("Coal","Fixed O&M") + Summary ("Gas","Fixed O&M") + Summary ("Solar","Fixed O&M")+Summary ("Wind","Fixed O&M")+Summary ("Total Stor.","Fixed O&M");
