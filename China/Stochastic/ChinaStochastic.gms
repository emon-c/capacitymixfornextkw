**** DEFINE UNCERT PARAMETER TO MULTIPLY THE SURPLUS AND UNSERVED ENERGY BY
...
CoalRamp /0.5/
GasRamp /0.5/
EmissionsCap /5638.685/
DatacenterRatio fraction of load to scale datacenter demand /0.2/;

$onText

----    152 PARAMETER TotalEmissions  

Avg  4734.806,    Low  5638.685,    High 4085.537
$offText
